...
with st.sidebar:
    ...
    year = st.selectbox("Select the NBA season you want to recap", list(reversed(range(1980, 2023))))
...
with pergame:
	...
	if len(teams)>0 and len(positions)>0:
		#Description
		st.write("This is a full point per game table based on your selections in the **Per game stats inputs** sidebar section. All teams and positions are automatically selected, but you can change it according to your preferences.")
